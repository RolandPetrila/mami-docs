...
- [x] **T7.B.1** — Ștergere intrări wellness individuale [LOW] [efort: MIC]
...
- [x] **T7.B.2** — Target hidratare + progress bar [LOW] [efort: MIC]
...
- [x] **T7.B.3** — Sparkline trend 7 zile (SVG inline, fără librărie) [MEDIUM] [efort: MEDIU]
...
- [x] **T7.B.4** 🌟 — Raport săptămânal PDF pentru doctor [MEDIUM] [efort: MEDIU]
...
- [x] **T7.C.1** 🌟 — Tab "Notițe" — Jurnal simplu [LOW] [efort: MIC]
...
- [x] **T7.C.2** 🌟🌟 — Tab "Tratament" — Lista medicamente personale + Remindere configurabile [HIGH] [efort: MEDIU-MARE]
...
- [x] **T7.C.3** — Editare caption galerie [LOW] [efort: MIC]
...
- [x] **T7.C.4** — Preferințe culinare meniu [MEDIUM] [efort: MEDIU]
...
- [x] **T7.C.5** — Export conversație chat [LOW] [efort: MIC]
...
- [x] **T7.D.1** 🌟 — PWA Share Target [MEDIUM] [efort: MIC]
...
- [x] **T7.D.2** — Shopping List din Meniu (AI-generat) [MEDIUM] [efort: MEDIU]
...
- [x] **T7.D.3** — Voice Memo cu transcripție [MEDIUM] [efort: MEDIU]
...
- [x] **T7.E.1** 🌟🌟 — Streaming AI responses (SSE) [HIGH IMPACT] [efort: MARE]
...
- [x] **T7.E.2** 🌟 — Bibliotecă persistentă documente [HIGH] [efort: MARE]
...
- [x] **T9.3** — Build cache Vite GitHub Actions [LOW] [efort: MIC]
...
- [x] **T9.7** — IndexedDB cleanup blob-uri orfane [LOW] [efort: MIC]
...
- [x] **T9.8** — Lazy import jsPDF wellness [LOW] [efort: MIC]
...
- [x] **T9.12** — Verifică `mami-ambient-player` (audit MED-10 fals positive) [LOW] [efort: MIC]
...
- [x] **T9.13** — Update SITEMAP.json cu tab-uri noi [LOW] [efort: MIC]
  - **Sursa:** audit [LOW]
...
- [x] **T10.2** — Lighthouse Production Run 2026-05-06 [efort: MEDIU]
  - **Cum:** `npx lighthouse https://mami-docs.pages.dev --form-factor=mobile --throttling.cpuSlowdownMultiplier=4`
  - **Rezultate:** Performance **92**, Accessibility **96** ✅, Best Practices **100** ✅, SEO **91**. FCP 1.1s, LCP 1.9s, TBT 330ms, CLS 0. Raport: `.claude-outputs/lighthouse/2026-05-06_post_sprint7.json`
  - **Notă:** Performance 92 (-2 față de baseline 94) — acceptabil pentru complexitatea adăugată în Sprint 7 (4 tab-uri noi, SSE, doc-library). Accessibility 96 depășește ținta 95. Lighthouse 12 nu mai are categoria PWA dedicată; criteriile PWA sunt în Best Practices (100).
...
| 2026-05-06 | Sprint 7.B — Wellness Avansat (T7.B.1-T7.B.4)         | ✅ Completat | T7.B.1 ștergere intrări (hidratare/vitals/somn/emoții) cu confirm(); T7.B.2 target hidratare configurabil + progress bar 3 culori; T7.B.3 sparkline SVG inline 7 zile; T7.B.4 raport săptămânal PDF formatat profesional pentru doctor (header colorat, secțiuni cu medii, flag-uri ⚠/✓). 139/139 tests. Commit `322639f`.                                                                                                                                                                                    |
| 2026-05-06 | Sprint 7.C — Tab-uri Noi & Features (T7.C.1-T7.C.5)   | ✅ Completat | T7.C.1 mami-notes.ts (4 categorii pin/edit/delete/search); T7.C.2 mami-medication.ts (cel mai cerut: lista + doze 60×60px + reminder setTimeout cu reschedule R6 + stock alert + export medic); T7.C.3 dblclick + long-press caption galerie; T7.C.4 preferințe culinare meniu (6 checkboxes + avoid + style); T7.C.5 export chat clipboard + .txt download. 139/139 tests. Commit `322639f`.                                                                                                                 |
| 2026-05-06 | Sprint 7.D — PWA Nativ (T7.D.1-T7.D.3)                | ✅ Completat | T7.D.1 PWA Share Target manifest + SW handler `share-target-temp` cache + main.ts dispatch; T7.D.2 lista cumpărături AI 6 categorii cu checkboxes; T7.D.3 mami-voice-memo.ts MediaRecorder webm/opus 2min + Whisper transcript + IDB. Tab nou Voce 🎙️. 139/139 tests. Commit `345242e`.                                                                                                                                                                                                                       |
| 2026-05-06 | Sprint 7.E + Faza 9 reziduuri                         | ✅ Completat | T7.E.1 SSE streaming AI (worker /chat-stream + heartbeat 25s mitigation R5 + fallback non-stream); T7.E.2 mami-doc-library.ts (📚 Biblioteca mea + doc-blob-store IDB separat + 4 categorii). Faza 9: T9.3 cache Vite GH Actions; T9.4 husky pre-commit (tsc + vitest); T9.5 vitest thresholds 70/70/60/70; T9.7 cleanupOrphanedDocBlobs; T9.13 SITEMAP v0.4.0. 139/139 tests. Commit `85411b1`.                                                                                                              |
